...
If your server is running on Amazon Web Services, you can use Amazon S3 instead of MinIO, since Sider uses Amazon S3.
See [Amazon S3](./amazon-s3.md) if you want to configure it.
