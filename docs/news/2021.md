...
## Tools update on December 27, 2021

<time className="NewsDate" dateTime="2021-12-27">December 27, 2021</time>

We’ve just updated the following tools! ✨

| Tool                                     | Language   | Version             | Ref                                                                    |
| ---------------------------------------- | ---------- | ------------------- | ---------------------------------------------------------------------- |
| [ESLint](../tools/javascript/eslint.md)  | JavaScript | 7.32.0 → **8.5.0**  | [changes](https://eslint.org/blog/2021/12/eslint-v8.5.0-released)      |
| [SwiftLint](../tools/swift/swiftlint.md) | Swift      | 0.45.0 → **0.45.1** | [changes](https://github.com/realm/SwiftLint/blob/0.45.1/CHANGELOG.md) |
...
<time className="NewsDate" dateTime="2021-10-04">October 4, 2021</time>
...
| [Slim-Lint](../tools/ruby/slim-lint.md)         | Ruby         | 0.22.0 → **0.22.1** | [changes](https://github.com/sds/slim-lint/blob/v0.22.1/CHANGELOG.md)        |
...
<time className="NewsDate" dateTime="2021-07-20">July 20, 2021</time>
